...
Bem-vindo ao meu repositório de estudos! Aqui documentarei minha evolução, algoritmos e projetos desenvolvidos ao longo do curso técnico em Desenvolvimento de Sistemas da Etec.
...
[![Status](https://img.shields.io/badge/Status-Em_Desenvolvimento-green?style=for-the-badge)](https://github.com/)

---

## 📂 Organização do Repositório

O repositório está organizado por disciplinas e atividades para facilitar a navegação:
...
<p align="left">
  <img src="https://img.shields.io/badge/Água-Saneamento-blue?style=flat-square&logo=waterdrop" alt="Saneamento">
  <img src="https://img.shields.io/badge/Lógica-Python-yellow?style=flat-square&logo=python" alt="Python">
</p>

Um sistema desenvolvido em Python para a companhia de saneamento municipal com o objetivo de classificar o perfil de consumo de água dos imóveis e emitir alertas educativos aos moradores com base em regras de negócio específicas.

- **Regras implementadas:**
  - **Comercial:** Exibe aviso de tarifa corporativa.
  - **Apartamento (< 10 m³):** Consumo econômico.
  - **Apartamento (qualquer consumo) ou Casa (até 25 m³):** Consumo moderado dentro do padrão residencial.
...
---
*Desenvolvido por Felipe Alexandre durante o curso técnico.*
